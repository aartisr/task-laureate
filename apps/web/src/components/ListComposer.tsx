...
export function ListComposer({ onCreate, onCancel, titleInputRef }: {
  ...
  return <form className="list-composer" onSubmit={(event) => void submit(event)} aria-label="Create a new list">
    <div className="list-composer__heading"><h2>Create a list</h2><p>Give this project or category a clear name. You can add tasks right after.</p></div>
