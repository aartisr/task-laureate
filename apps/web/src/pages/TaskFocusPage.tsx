...
export function TaskFocusPage({ listId, taskId }: { listId: string; taskId: string }) {
  ...
  if (listQuery.isLoading || tasksQuery.isLoading) return <main className="task-focus-page" aria-busy="true">Loading task…</main>;
  ...
  return <main className="task-focus-page">
    ...
    <TaskDetailLens
      ...
      mode="focus"
      readOnly={listQuery.data.status === 'archived'}
